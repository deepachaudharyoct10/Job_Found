...
const RecruiterDashboard = () => {
  const { user } = useAuth();
  const { companies, jobs, applications, addCompany, addJob, updateApplicationStatus, getJobsByRecruiter, getApplicationsByJob } = useData();
  ...
  const totalApplications = recruiterJobs.reduce((sum, job) => sum + job.totalApplicants, 0);
  ...
  const handleAddCompany = (e) => {
    ...
    setCompanyForm({ name: '', description: '', location: '', industry: '', size: '' });
